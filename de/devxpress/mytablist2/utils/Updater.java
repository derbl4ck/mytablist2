...
public class Updater {
        ...
        try {
            ...
            while ((count = in.read(data, 0, Updater.BYTE_SIZE)) != -1) {
                ...
                if (this.announce && ((percent % 10) == 0)) {
                    this.plugin.getLogger().info("Downloading Update: " + percent + "%");
                }
            }
            ...
            if (this.announce) {
                ...
                this.plugin.getLogger().info(versionName + " Installed!");
            }
    ...
    private boolean read() {
        try {
            ...
            //conn.addRequestProperty("X-API-Key", String.valueOf(id));
            ...
            if (e.getMessage().contains("HTTP response code: 403")) {
                this.plugin.getLogger().severe("dev.bukkit.org rejected the connection.");
